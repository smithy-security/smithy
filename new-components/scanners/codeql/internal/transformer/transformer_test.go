...
import (
	...
	"github.com/smithy-security/smithy/new-components/scanners/codeql/internal/transformer"
)
...
func TestCodeQLTransformer_Transform(t *testing.T) {
	...
	ocsfTransformer, err := transformer.New(
		transformer.CodeqlRawOutDirGlob("testdata/*.sarif.json"),
