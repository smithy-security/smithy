...
func (e *executor) Execute(ctx context.Context, wf *v1.Workflow) error {
...
func (e *executor) executeStep(ctx context.Context, instanceID uuid.UUID, step v1.Step) error {
...
func (e *executor) cleanup(ctx context.Context) {
	...
	if err := os.RemoveAll(reposLocation); err != nil {
		logger.Error(
			"could not remove cloned repositories",
			slog.String("path", reposLocation),
