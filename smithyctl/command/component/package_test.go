...
func TestParseComponentSpec(t *testing.T) {
	for _, tt := range []struct {
		...
		},
		{
			...
			componentSpecPath: "testdata/package/invalid/smithy-component.yaml",
			isValid:           false,
		},
		{
			testCase:          "it should return an error because the yml spec is invalid",
			componentSpecPath: "testdata/package/invalid/smithy-component.yml",
			isValid:           false,
		},
		{
			testCase:          "it should correctly parse the yaml spec",
			componentSpecPath: "testdata/package/valid/smithy-component.yaml",
			isValid:           true,
		},
		{
			testCase:          "it should correctly parse the yml spec",
			componentSpecPath: "testdata/package/valid/smithy-component.yml",
			isValid:           true,
		},
	} {
