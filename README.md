...
```yaml
# Example: Run SAST, SCA, Secrets and IAC scanning, remove unreachable findings and report to Jira
...
- component: #todo replace with custom annotation
- component: # todo: replace with table/ascii magic
```
...
- component: ghcr.io/smithy-security/smithy/manifests/components/targets/git-clone:v1.4.0
- component: ghcr.io/smithy-security/smithy/manifests/components/scanners/semgrep:v1.3.2
- component: file://components/enrichers/datagerry/component.yaml
- component: # todo replace with table/concise logger
