...
class RemoteDBManager(DBManager):
    ...
    def __init__(
        self,
        instance_id: str,
        findings_address: str,
        max_attempts: int,
        initial_backoff_seconds: str,
        ...
        :param findings_address: The address of the remote findings service (gRPC server).
        :type findings_address: str
        :param max_attempts: The maximum number of attempts to connect to the remote database.
        :type max_attempts: int
        :param initial_backoff_seconds: The initial backoff time for retrying connection
        :type initial_backoff_seconds: str
        :param max_backoff_seconds: The maximum backoff time for retrying connection
        :type max_backoff_seconds: str
        :param backoff_multiplier: The multiplier for the backoff time.
        :type backoff_multiplier: float
        :param page_size: The number of findings to retrieve per page. Default is 100
        :type page_size: int
        ...
        self.findings_address = findings_address
    ...
    def get_findings(
        ...
        try:
            while True:
                ...
                if (
                    len(resp.findings) < get_findings_page_size
