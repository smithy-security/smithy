...
func (x *Enrichment) GetGitHistory() *Enrichment_GitHistory {
	if x, ok := x.GetEnrichment().(*Enrichment_GitHistory_); ok {
		return x.GitHistory
	}
	return nil
}
...
func (x *Enrichment) GetRemediation() *Enrichment_Remediation {
	if x, ok := x.GetEnrichment().(*Enrichment_Remediation_); ok {
...
func (*Enrichment_GitHistory_) isEnrichment_Enrichment() {}

func (*Enrichment_Remediation_) isEnrichment_Enrichment() {}
...
func (x *Enrichment_GitHistory) Reset() {
	*x = Enrichment_GitHistory{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ocsf_ext_finding_info_v1_finding_info_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Enrichment_GitHistory) Descriptor() ([]byte, []int) {
	return file_ocsf_ext_finding_info_v1_finding_info_proto_rawDescGZIP(), []int{1, 6}
}
...
func (x *Enrichment_Remediation) Reset() {
	*x = Enrichment_Remediation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ocsf_ext_finding_info_v1_finding_info_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Enrichment_Remediation) Descriptor() ([]byte, []int) {
	return file_ocsf_ext_finding_info_v1_finding_info_proto_rawDescGZIP(), []int{1, 7}
}
...
var file_ocsf_ext_finding_info_v1_finding_info_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x22, 0xf8, 0x0d, 0x0a, 0x0a, 0x45, 0x6e,
	...
	0x06, 0x70, 0x72, 0x44, 0x69, 0x66, 0x66, 0x12, 0x49, 0x0a, 0x0b, 0x67, 0x69, 0x74, 0x5f, 0x68,
	0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x66,
	0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x45,
	0x6e, 0x72, 0x69, 0x63, 0x68, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x47, 0x69, 0x74, 0x48, 0x69, 0x73,
	0x74, 0x6f, 0x72, 0x79, 0x48, 0x00, 0x52, 0x0a, 0x67, 0x69, 0x74, 0x48, 0x69, 0x73, 0x74, 0x6f,
	0x72, 0x79, 0x12, 0x4b, 0x0a, 0x0b, 0x72, 0x65, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x66, 0x69, 0x6e, 0x64, 0x69, 0x6e,
	...
	0x48, 0x00, 0x52, 0x0b, 0x72, 0x65, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x1a,
	0x15, 0x0a, 0x13, 0x44, 0x75, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x65, 0x45, 0x6e, 0x72, 0x69,
	0x63, 0x68, 0x6d, 0x65, 0x6e, 0x74, 0x1a, 0x33, 0x0a, 0x15, 0x43, 0x6f, 0x72, 0x72, 0x65, 0x6c,
	...
	,
	...
	0x0d, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x4c, 0x69, 0x6e, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65,
	...
	,
	...
	,
...
var file_ocsf_ext_finding_info_v1_finding_info_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_ocsf_ext_finding_info_v1_finding_info_proto_goTypes = []interface{}{
	...
	(*Enrichment_GitHistory)(nil),              // 17: finding_info.v1.Enrichment.GitHistory
	(*Enrichment_Remediation)(nil),             // 18: finding_info.v1.Enrichment.Remediation
	(v1.IncidentFinding_VerdictId)(0),          // 19: ocsf_schema.v1.IncidentFinding.VerdictId
}
var file_ocsf_ext_finding_info_v1_finding_info_proto_depIdxs = []int32{
	...
	17, // 14: finding_info.v1.Enrichment.git_history:type_name -> finding_info.v1.Enrichment.GitHistory
	18, // 15: finding_info.v1.Enrichment.remediation:type_name -> finding_info.v1.Enrichment.Remediation
	1,  // 16: finding_info.v1.DataSource.URI.uri_schema:type_name -> finding_info.v1.DataSource.URISchema
	19, // 17: finding_info.v1.Enrichment.InvestigationEnrichment.status:type_name -> ocsf_schema.v1.IncidentFinding.VerdictId
...
func file_ocsf_ext_finding_info_v1_finding_info_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ocsf_ext_finding_info_v1_finding_info_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Enrichment_GitHistory); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ocsf_ext_finding_info_v1_finding_info_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Enrichment_Remediation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_ocsf_ext_finding_info_v1_finding_info_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*Enrichment_GitHistory_)(nil),
		(*Enrichment_Remediation_)(nil),
	}
	type x struct{}
